#!/usr/bin/env bash
# run-dkz screencast, STEP 2 — DKG instance for SPO 3 (bifrost 0x11×31+0x03, listens :18502).
#
...
exec ./target/debug/heimdall run-spo --config heimdall-spo3.toml --deterministic "$@"

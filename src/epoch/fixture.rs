...
/// from Config #15–#16 wherever the bridge publishes it, with the operator's
/// local seed only a cross-check. Resolving it needs a Config read, which is the
/// caller's to do — see [`crate::cardano::federation::resolve`].
